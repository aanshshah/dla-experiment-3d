...
public class ScrollScript : MonoBehaviour {
	...
	void Update () {
        ...
        if (isScrolling)
        {
            ...
            Vector3 _incrementYPosition = new Vector3(_currentUIPosition.x + .1f * Mathf.Sin(Mathf.Deg2Rad * rotation),
                                                      _currentUIPosition.y + .1f * Mathf.Cos(Mathf.Deg2Rad * rotation),
